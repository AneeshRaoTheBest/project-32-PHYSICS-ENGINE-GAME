...
//making an arrays to hold all the pins
//9 rows
var bottles = [[],[],[],[],[],[],[],[]];
var baseball, toss;
var gameState = "start";
...
function draw() {
  ...
  if(gameState === "start") {
  		textSize(24)
  		text("Instructions: Try to knock all the pins down with the least amount of misses and turns! Press space to get another turn",150, 125, 350)
	}
  pop()
